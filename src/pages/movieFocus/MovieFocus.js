    ...
    const handleMoviePlayer = async () => {
        ...
        if (checked === 403 || checked === 401 || checked === 400 || checked === 500) {
            ...
            navigation.navigate("MoviePlayer", {
                fileURL: allData.movie.movieUrl,
            });
        }
        setLoading(false);
    };
            ...
            <View style={styles.modalFilter}>
                <View style={styles.modalContainer}>
                    <Text style={styles.title}>
                        No puedes ver "{allData.movie.title}"
                    </Text>
                    <Text style={styles.description}>
                        Para ver este título, debes suscribirte a un paquete que
                        pueda reproducir esta película.
                    </Text>
                        ...
                        <View style={styles.mainHeader}>
                            ...
                            <View style={styles.movieData}>
                                <Text style={styles.movieDataText}>
                                    {allData.movie.minAge}
                                </Text>
                                <Text style={styles.movieDataText}>
                                    {allData.movie.duration} Minutos
                                </Text>
                                <Text style={styles.movieDataText}>
                                    <Ionicons
                                        name={"star"}
                            ...
                            <TouchableOpacity
                                style={styles.playMovie}
                                onPress={() => handleMoviePlayer()}
                                disabled={loading}
                            >
                                {loading ? (
                                    <ActivityIndicator
                                    ...
                                    <Text style={styles.playMovieText}>
                                        Reproducir
                                    </Text>
                                )}
                            </TouchableOpacity>
